...
import org.one.note.noted.domain.CommentDataOnDemand;
...
privileged aspect CommentIntegrationTest_Roo_IntegrationTest {
    ...
    public void CommentIntegrationTest.testCountComments() {
        ...
        long count = org.one.note.noted.domain.Comment.countComments();
    ...
    public void CommentIntegrationTest.testFindComment() {
        org.one.note.noted.domain.Comment obj = dod.getRandomComment();
        ...
        obj = org.one.note.noted.domain.Comment.findComment(id);
    ...
    public void CommentIntegrationTest.testFindAllComments() {
        ...
        java.util.List<org.one.note.noted.domain.Comment> result = org.one.note.noted.domain.Comment.findAllComments();
    ...
    public void CommentIntegrationTest.testFindCommentEntries() {
        ...
        java.util.List<org.one.note.noted.domain.Comment> result = org.one.note.noted.domain.Comment.findCommentEntries(0, (int) count);
    ...
    public void CommentIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyComment(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.one.note.noted.domain.Comment merged =  obj.merge();
        obj.flush();
    ...
    public void CommentIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Comment' failed to initialize correctly", dod.getRandomComment());
        org.one.note.noted.domain.Comment obj = dod.getNewTransientComment(Integer.MAX_VALUE);
    ...
    public void CommentIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Comment' with identifier '" + id + "'", org.one.note.noted.domain.Comment.findComment(id));
    }
