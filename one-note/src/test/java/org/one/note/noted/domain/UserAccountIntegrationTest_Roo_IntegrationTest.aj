...
privileged aspect UserAccountIntegrationTest_Roo_IntegrationTest {
    ...
    public void UserAccountIntegrationTest.testCountUserAccounts() {
        ...
        long count = org.one.note.noted.domain.UserAccount.countUserAccounts();
    ...
    public void UserAccountIntegrationTest.testFindUserAccount() {
        org.one.note.noted.domain.UserAccount obj = dod.getRandomUserAccount();
        ...
        obj = org.one.note.noted.domain.UserAccount.findUserAccount(id);
    ...
    public void UserAccountIntegrationTest.testFindAllUserAccounts() {
        ...
        java.util.List<org.one.note.noted.domain.UserAccount> result = org.one.note.noted.domain.UserAccount.findAllUserAccounts();
    ...
    public void UserAccountIntegrationTest.testFindUserAccountEntries() {
        ...
        java.util.List<org.one.note.noted.domain.UserAccount> result = org.one.note.noted.domain.UserAccount.findUserAccountEntries(0, (int) count);
    ...
    public void UserAccountIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyUserAccount(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.one.note.noted.domain.UserAccount merged =  obj.merge();
        obj.flush();
    ...
    public void UserAccountIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'UserAccount' failed to initialize correctly", dod.getRandomUserAccount());
        org.one.note.noted.domain.UserAccount obj = dod.getNewTransientUserAccount(Integer.MAX_VALUE);
    ...
    public void UserAccountIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'UserAccount' with identifier '" + id + "'", org.one.note.noted.domain.UserAccount.findUserAccount(id));
    }
