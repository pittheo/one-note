...
<html lang="en">
  ...
  <body>
	...
	<form id="songEntryForm" action="/one-note/songentrys/" method="POST">
      <div class="row">
    ...
    <script type="text/javascript"> 
		$(document).ready(function() {
			...
			var findLyricsForSong = function(songTitle) {
				...
				$("#songEntryForm").append("<input type='hidden' name='songTitle' value='" + songTitle + "'/>");
				$.ajax({
					type: "GET",
					...
					success: function(json) {
						...
						$('.chordable').click(function(ev) {
							...
							var chordPositionText = chord + ";" + pos
							$("#songEntryForm").append("<input type='hidden' name='chordPositions' value='" + chordPositionText + "'/>");
			...
			var cb = function(searchResults) {
				...
				for (var i=0; i<searchResults.length; i++) {
					...
					$("#songEntryForm").append("<input type='hidden' name='savedVideos' value='" + searchResults[i].playUrl + "'/>");
				}
			};
